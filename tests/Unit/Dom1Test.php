<?php
    ...
    final class Dom1Test extends TestCase
    {
                        ...
                        $_i[] = Col::ins()->inner(function(Col $this_, array &$_i) {
                            ...
                            $_i[] = Card::ins()->inner(function(Card $this_, array &$_i) {
                                ...
                                $_i[] = LayuiDoubleTag::ins('div')->inner(function(LayuiDoubleTag $this_, array &$_i) {
                                    ...
                                    $_i[] = LayuiDoubleTag::ins('span')
                                        ->inner(function(LayuiDoubleTag $this_, array &$_i) {
                                            $this_->fontCyan();
...
//                            $this_->setSelected('2,3');
                                    ...
                                    $this_->setOptions([
                                        ...
                                        2 => [
                                            "label"    => $title . "_2",
                                            "selected" => true,
                                            "content"  => Blockquote::ins()
                                                ->inner(function(Blockquote $this_, array &$_i) {
                                                    $this_->margin(3);
                                                    $this_->padding(2);
                                                    $this_->withBorder();
