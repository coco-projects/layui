<?php
    ...
    class SingleImgUploader extends ComponentBase
    {
...
<div class="layui-input-block ">
    <div class="layui-margin-2 layui-padding-2 layui-bg-gray">
        <div  class="layui-bg-gray {:disabled:} layui-upload-drag" id="{:id:}_upload_btn" >
            ...
            <div class="layui-bg-blue layui-padding-2">点击选择图片，或拖拽图片到此区域</div>
        </div>
        <div style="width: 100%;">
            <div class="layui-upload-list">
                <img class="layui-upload-img single_img_preview" id="{:id:}_upload_preview" src="{:upload_preview:}" alt="no preview" style="width: auto;height: 100px;display: none">
            </div>
...
CONTENTS;
        ...
        public function setPreview(string $value): static
        {
            $this->setSubsection('upload_preview', $value);
    ...
    var uploadInst = upload.render({
        ...
        before: function (obj) {
            ...
            obj.preview(function (index, file, result) {
                $("#{:id:}_upload_preview").attr("src", result); // 图片链接（base64）
            });
            ...
            else
            {
                ...
                $("#{:id:}_upload_preview").attr("src",res.data);
            }
